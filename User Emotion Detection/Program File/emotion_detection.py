...
def getEmotion(i):
        ...
        return switcher.get(i,"Invalid Emotion")
...
#print(data['sentiment'],'  ', data['content'])
...
#data['emotion_code']=lbl_enc.fit_transform(data.sentiment.values)
#data.to_csv('em.csv')
...
#logreg = LogisticRegression(C=1,solver='lbfgs',multi_class='auto',max_iter=4000)
...
msg=['I am very happy today! The atmosphere looks cheerful',
...
while True:
        m= input("enter u r message")
        if(m=='thanks'):
                break
        
        msg.append(m)
        tweets = pd.DataFrame(msg)
...
# Doing some preprocessing on these tweets as done before
        ...
        for t in tweet_pred:
            print(tweets[0][i],t,': [',getEmotion(t),']') 
            i=i+1
## result
## [0 0 0 0 1 1 1 1]
